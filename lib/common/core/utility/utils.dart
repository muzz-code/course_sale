...
class Utils{
  ...
  static Offset getThrowOffsetFromDragLocation(Offset drag, double min) {
    return Offset(
  ...
  static int getModIndexFromActiveIndex(
      int index,
      int activeIndex,
      int count, {
  ...
  static double getScaleByIndex(int index, double min, double max, int count) {
